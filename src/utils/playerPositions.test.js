...
describe('isForward', () => {
  ...
  test('if invalid parameters are provided, throw error', () => {
    expect(() => { playerPositionsHelper.isForward(1) }).toThrow(Error)
    expect(() => { playerPositionsHelper.isForward({}) }).toThrow(Error)
    expect(() => { playerPositionsHelper.isForward([]) }).toThrow(Error)
  })
...
describe('isBack', () => {
  ...
  test('if invalid parameters are provided, throw error', () => {
    expect(() => { playerPositionsHelper.isBack(1) }).toThrow(Error)
    expect(() => { playerPositionsHelper.isBack({}) }).toThrow(Error)
    expect(() => { playerPositionsHelper.isBack([]) }).toThrow(Error)
  })
